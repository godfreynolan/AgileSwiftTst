...
internal let sourcekitd_set_interrupted_connection_handler: @convention(c) (sourcekitd_interrupted_connection_handler_t) -> Void = library.load(symbol: "sourcekitd_set_interrupted_connection_handler")
...
internal let sourcekitd_request_dictionary_set_string: @convention(c) (sourcekitd_object_t, sourcekitd_uid_t, UnsafePointer<Int8>) -> Void = library.load(symbol: "sourcekitd_request_dictionary_set_string")
internal let sourcekitd_request_dictionary_set_stringbuf: @convention(c) (sourcekitd_object_t, sourcekitd_uid_t, UnsafePointer<Int8>, Int) -> Void = library.load(symbol: "sourcekitd_request_dictionary_set_stringbuf")
...
internal let sourcekitd_request_array_set_string: @convention(c) (sourcekitd_object_t, Int, UnsafePointer<Int8>) -> Void = library.load(symbol: "sourcekitd_request_array_set_string")
internal let sourcekitd_request_array_set_stringbuf: @convention(c) (sourcekitd_object_t, Int, UnsafePointer<Int8>, Int) -> Void = library.load(symbol: "sourcekitd_request_array_set_stringbuf")
