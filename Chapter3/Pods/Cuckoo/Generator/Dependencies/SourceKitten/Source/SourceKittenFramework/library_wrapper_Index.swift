...
internal let clang_disposeIndex: @convention(c) (CXIndex?) -> Void = library.load(symbol: "clang_disposeIndex")
internal let clang_CXIndex_setGlobalOptions: @convention(c) (CXIndex?, UInt32) -> Void = library.load(symbol: "clang_CXIndex_setGlobalOptions")
...
internal let clang_getExpansionLocation: @convention(c) (CXSourceLocation, UnsafeMutablePointer<CXFile?>?, UnsafeMutablePointer<UInt32>?, UnsafeMutablePointer<UInt32>?, UnsafeMutablePointer<UInt32>?) -> Void = library.load(symbol: "clang_getExpansionLocation")
internal let clang_getPresumedLocation: @convention(c) (CXSourceLocation, UnsafeMutablePointer<CXString>?, UnsafeMutablePointer<UInt32>?, UnsafeMutablePointer<UInt32>?) -> Void = library.load(symbol: "clang_getPresumedLocation")
internal let clang_getInstantiationLocation: @convention(c) (CXSourceLocation, UnsafeMutablePointer<CXFile?>?, UnsafeMutablePointer<UInt32>?, UnsafeMutablePointer<UInt32>?, UnsafeMutablePointer<UInt32>?) -> Void = library.load(symbol: "clang_getInstantiationLocation")
internal let clang_getSpellingLocation: @convention(c) (CXSourceLocation, UnsafeMutablePointer<CXFile?>?, UnsafeMutablePointer<UInt32>?, UnsafeMutablePointer<UInt32>?, UnsafeMutablePointer<UInt32>?) -> Void = library.load(symbol: "clang_getSpellingLocation")
internal let clang_getFileLocation: @convention(c) (CXSourceLocation, UnsafeMutablePointer<CXFile?>?, UnsafeMutablePointer<UInt32>?, UnsafeMutablePointer<UInt32>?, UnsafeMutablePointer<UInt32>?) -> Void = library.load(symbol: "clang_getFileLocation")
...
internal let clang_disposeSourceRangeList: @convention(c) (UnsafeMutablePointer<CXSourceRangeList>?) -> Void = library.load(symbol: "clang_disposeSourceRangeList")
...
internal let clang_disposeDiagnosticSet: @convention(c) (CXDiagnosticSet?) -> Void = library.load(symbol: "clang_disposeDiagnosticSet")
...
internal let clang_disposeDiagnostic: @convention(c) (CXDiagnostic?) -> Void = library.load(symbol: "clang_disposeDiagnostic")
...
internal let clang_disposeTranslationUnit: @convention(c) (CXTranslationUnit?) -> Void = library.load(symbol: "clang_disposeTranslationUnit")
...
internal let clang_disposeCXTUResourceUsage: @convention(c) (CXTUResourceUsage) -> Void = library.load(symbol: "clang_disposeCXTUResourceUsage")
...
internal let clang_disposeCXPlatformAvailability: @convention(c) (UnsafeMutablePointer<CXPlatformAvailability>?) -> Void = library.load(symbol: "clang_disposeCXPlatformAvailability")
...
internal let clang_disposeCXCursorSet: @convention(c) (CXCursorSet?) -> Void = library.load(symbol: "clang_disposeCXCursorSet")
...
internal let clang_getOverriddenCursors: @convention(c) (CXCursor, UnsafeMutablePointer<UnsafeMutablePointer<CXCursor>?>?, UnsafeMutablePointer<UInt32>?) -> Void = library.load(symbol: "clang_getOverriddenCursors")
internal let clang_disposeOverriddenCursors: @convention(c) (UnsafeMutablePointer<CXCursor>?) -> Void = library.load(symbol: "clang_disposeOverriddenCursors")
...
internal let clang_tokenize: @convention(c) (CXTranslationUnit?, CXSourceRange, UnsafeMutablePointer<UnsafeMutablePointer<CXToken>?>?, UnsafeMutablePointer<UInt32>?) -> Void = library.load(symbol: "clang_tokenize")
internal let clang_annotateTokens: @convention(c) (CXTranslationUnit?, UnsafeMutablePointer<CXToken>?, UInt32, UnsafeMutablePointer<CXCursor>?) -> Void = library.load(symbol: "clang_annotateTokens")
internal let clang_disposeTokens: @convention(c) (CXTranslationUnit?, UnsafeMutablePointer<CXToken>?, UInt32) -> Void = library.load(symbol: "clang_disposeTokens")
...
internal let clang_getDefinitionSpellingAndExtent: @convention(c) (CXCursor, UnsafeMutablePointer<UnsafePointer<Int8>?>?, UnsafeMutablePointer<UnsafePointer<Int8>?>?, UnsafeMutablePointer<UInt32>?, UnsafeMutablePointer<UInt32>?, UnsafeMutablePointer<UInt32>?, UnsafeMutablePointer<UInt32>?) -> Void = library.load(symbol: "clang_getDefinitionSpellingAndExtent")
internal let clang_enableStackTraces: @convention(c) () -> Void = library.load(symbol: "clang_enableStackTraces")
...
internal let clang_sortCodeCompletionResults: @convention(c) (UnsafeMutablePointer<CXCompletionResult>?, UInt32) -> Void = library.load(symbol: "clang_sortCodeCompletionResults")
internal let clang_disposeCodeCompleteResults: @convention(c) (UnsafeMutablePointer<CXCodeCompleteResults>?) -> Void = library.load(symbol: "clang_disposeCodeCompleteResults")
...
internal let clang_toggleCrashRecovery: @convention(c) (UInt32) -> Void = library.load(symbol: "clang_toggleCrashRecovery")
internal let clang_getInclusions: @convention(c) (CXTranslationUnit?, CXInclusionVisitor?, CXClientData?) -> Void = library.load(symbol: "clang_getInclusions")
...
internal let clang_remap_getFilenames: @convention(c) (CXRemapping?, UInt32, UnsafeMutablePointer<CXString>?, UnsafeMutablePointer<CXString>?) -> Void = library.load(symbol: "clang_remap_getFilenames")
internal let clang_remap_dispose: @convention(c) (CXRemapping?) -> Void = library.load(symbol: "clang_remap_dispose")
...
internal let clang_index_setClientContainer: @convention(c) (UnsafePointer<CXIdxContainerInfo>?, CXIdxClientContainer?) -> Void = library.load(symbol: "clang_index_setClientContainer")
...
internal let clang_index_setClientEntity: @convention(c) (UnsafePointer<CXIdxEntityInfo>?, CXIdxClientEntity?) -> Void = library.load(symbol: "clang_index_setClientEntity")
internal let clang_IndexAction_create: @convention(c) (CXIndex?) -> (CXIndexAction!) = library.load(symbol: "clang_IndexAction_create")
internal let clang_IndexAction_dispose: @convention(c) (CXIndexAction?) -> Void = library.load(symbol: "clang_IndexAction_dispose")
...
internal let clang_indexLoc_getFileLocation: @convention(c) (CXIdxLoc, UnsafeMutablePointer<CXIdxClientFile?>?, UnsafeMutablePointer<CXFile?>?, UnsafeMutablePointer<UInt32>?, UnsafeMutablePointer<UInt32>?, UnsafeMutablePointer<UInt32>?) -> Void = library.load(symbol: "clang_indexLoc_getFileLocation")
